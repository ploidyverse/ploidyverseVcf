...
#ifndef RCPP_ploidyverseClasses_RCPPEXPORTS_H_GEN_
#define RCPP_ploidyverseClasses_RCPPEXPORTS_H_GEN_

#include <Rcpp.h>

namespace ploidyverseClasses {
    ...
    namespace {
        void validateSignature(const char* sig) {
            ...
            require("ploidyverseClasses", Rcpp::Named("quietly") = true);
            typedef int(*Ptr_validate)(const char*);
            static Ptr_validate p_validate = (Ptr_validate)
                R_GetCCallable("ploidyverseClasses", "_ploidyverseClasses_RcppExport_validate");
            if (!p_validate(sig)) {
                throw Rcpp::function_not_exported(
                    "C++ function with signature '" + std::string(sig) + "' not found in ploidyverseClasses");
            }
        }
    }
    ...
    inline double dmultinom(NumericVector x, NumericVector prob) {
        ...
        if (p_dmultinom == NULL) {
            ...
            p_dmultinom = (Ptr_dmultinom)R_GetCCallable("ploidyverseClasses", "_ploidyverseClasses_dmultinom");
        }
    ...
    inline double dDirichletMultinom(NumericVector x, NumericVector prob, double alpha) {
        ...
        if (p_dDirichletMultinom == NULL) {
            ...
            p_dDirichletMultinom = (Ptr_dDirichletMultinom)R_GetCCallable("ploidyverseClasses", "_ploidyverseClasses_dDirichletMultinom");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline int nGen(int ploidy, int nalleles) {
        ...
        if (p_nGen == NULL) {
            ...
            p_nGen = (Ptr_nGen)R_GetCCallable("ploidyverseClasses", "_ploidyverseClasses_nGen");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline IntegerMatrix enumerateGenotypes(int ploidy, int nalleles) {
        ...
        if (p_enumerateGenotypes == NULL) {
            ...
            p_enumerateGenotypes = (Ptr_enumerateGenotypes)R_GetCCallable("ploidyverseClasses", "_ploidyverseClasses_enumerateGenotypes");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline int indexGenotype(IntegerVector genotype) {
        ...
        if (p_indexGenotype == NULL) {
            ...
            p_indexGenotype = (Ptr_indexGenotype)R_GetCCallable("ploidyverseClasses", "_ploidyverseClasses_indexGenotype");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline IntegerVector genotypeFromIndex(int index, int ploidy) {
        ...
        if (p_genotypeFromIndex == NULL) {
            ...
            p_genotypeFromIndex = (Ptr_genotypeFromIndex)R_GetCCallable("ploidyverseClasses", "_ploidyverseClasses_genotypeFromIndex");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline IntegerVector alleleCopy(IntegerVector genotype, int nalleles) {
        ...
        if (p_alleleCopy == NULL) {
            ...
            p_alleleCopy = (Ptr_alleleCopy)R_GetCCallable("ploidyverseClasses", "_ploidyverseClasses_alleleCopy");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline IntegerMatrix makeGametes(IntegerVector genotype) {
        ...
        if (p_makeGametes == NULL) {
            ...
            p_makeGametes = (Ptr_makeGametes)R_GetCCallable("ploidyverseClasses", "_ploidyverseClasses_makeGametes");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline NumericMatrix selfingMatrix(int ploidy, int nalleles) {
        ...
        if (p_selfingMatrix == NULL) {
            ...
            p_selfingMatrix = (Ptr_selfingMatrix)R_GetCCallable("ploidyverseClasses", "_ploidyverseClasses_selfingMatrix");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
...
#endif // RCPP_ploidyverseClasses_RCPPEXPORTS_H_GEN_
